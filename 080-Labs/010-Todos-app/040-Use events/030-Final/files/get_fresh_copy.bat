...
MKDIR "%TGT%\Events" > nul
ECHO          get from %SRC%Events\
COPY "%SRC%Events\TodoCreated.php" "%TGT%Events\"
...
MKDIR "%TGT%\Listeners" > nul
ECHO          get from %SRC%Listeners\
COPY "%SRC%Listeners\Created.php" "%TGT%Listeners\"
COPY "%SRC%Listeners\LoginSuccess.php" "%TGT%Listeners\"
COPY "%SRC%Listeners\LoginSuccessMilk.php" "%TGT%Listeners\"

MKDIR "%TGT%\Providers"
ECHO          get from %SRC%Providers\
COPY "%SRC%Providers\AppServiceProvider.php" "%TGT%Providers\"
COPY "%SRC%Providers\EventServiceProvider.php" "%TGT%Providers\"
...
COPY "%SRC%views\home.blade.php" "%TGT%\views"
